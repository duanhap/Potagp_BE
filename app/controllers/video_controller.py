...
def get_public_videos():
    ...
    """
    videos = video_service.get_public_videos()
    return jsonify({
        'success': True,
...
def get_my_videos():
    ...
    videos, error = video_service.get_my_videos(uid)
...
def create_public_video():
    ...
    video, error = video_service.create_public_video(uid, title, thumbnail, source_url, type_video)
...
def create_my_video():
    ...
    video, error = video_service.create_my_video(uid, title, thumbnail, source_url, type_video)
